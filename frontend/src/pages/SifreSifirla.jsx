...
import { sifreSifrarlaTamamla } from '../api'
...
export default function SifreSifirla() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-gray-500 mb-4">Bu link eksik veya hatalı.</p>
          <Link to="/sifre-unuttum" className="text-sm text-tatko hover:underline">Yeni link isteyin</Link>
        </div>
      </div>
    )
  }
  ...
  const handleGonder = async (e) => {
    ...
    setYukleniyor(true)
    try {
      await sifreSifrarlaTamamla(token, yeniSifre)
      setBasarili(true)
    } catch (err) {
      setHata(err.message || 'Geçersiz veya süresi dolmuş link.')
    } finally {
      setYukleniyor(false)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-xl font-medium text-gray-900 mb-2">Şifreniz güncellendi</h1>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-medium text-gray-900">Yeni şifre belirle</h1>
          <p className="text-sm text-gray-500 mt-1">Hesabınız için güçlü bir şifre seçin.</p>
        </div>
